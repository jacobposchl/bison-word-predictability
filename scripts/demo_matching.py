...
CS_SENTENCE = "即係 同 啲 friend 就 好 少 會 成個"
CS_SENTENCE_POS = "CCONJ ADP NOUN NOUN ADV ADV ADJ AUX ADJ"
CS_TRANSLATION = "即係 同 啲 朋友 就 好 少 會 成個"
CS_TRANSLATED_POS = "CCONJ ADP NOUN NOUN ADV ADV ADJ AUX ADJ"
SWITCH_INDEX = 3  # Index where switch occurs (0-based)
WINDOW_SIZE = 1  # Window size for matching
PARTICIPANT_ID = "ACHE2003"  # Speaker ID
GROUP = "Heritage"  # Speaker group
